...
const translations = {
  ...
  tr: {
    ...
    'status.bothVerified': 'Her iki eş de doğrulandı — güvenli aktarım hazır.',
    'status.waitingPeerVerify': 'Eşin güvenlik kodunu doğrulaması bekleniyor...',
    'status.peerVerifiedConfirm': 'Eş doğrulandı. Aktarımları etkinleştirmek için kodu onaylayın.',
    'status.verifyBoth': 'Devam etmek için güvenlik kodunu her iki istemcide de doğrulayın.',
    'status.waitingOtherPeer': 'Diğer eşin bu odaya katılması bekleniyor...',
    'status.peerDisconnected': 'Eş bağlantısı kesildi. Eşin yeniden bağlanması bekleniyor...',
    ...
    'alert.verifyBeforeSend': 'Lütfen dosyaları göndermeden önce güvenlik kodunu eşinizle doğrulayın.',
    'alert.peerNotVerified': 'Eşiniz güvenlik kodunu henüz doğrulamadı. Göndermeden önce onaylamalarını bekleyin.',
    'alert.incomingVerify': 'Bir eş size dosya göndermeye çalışıyor. Almak için güvenlik kodunu doğrulayın.',
    'alert.checksumMismatch': 'Güvenlik Bütünlüğü Hatası: "{name}" dosyasında sağlama toplamı uyuşmuyor! Aktarım iptal edildi.',
    'alert.peerNotVerifiedAbort': 'Eşiniz güvenlik kodunu henüz doğrulamadı. Aktarım iptal edildi — doğrulamalarını isteyin, sonra yeniden gönderin.',
